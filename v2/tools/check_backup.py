...
from mylife.backup_hash import assert_verified_legacy_backup
...
def main():
    parser = argparse.ArgumentParser(description="Read-only validation of the verified recovered MyLife backup")
    parser.add_argument("backup")
    args = parser.parse_args()

    assert_verified_legacy_backup(args.backup)
